...
This directory is the local SDKWork component contract for `@sdkwork/modelkit-sdk-typescript`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/sdks/sdkwork-modelkit-sdk-typescript`
