...
This directory is the local SDKWork component contract for `@sdkwork/modelkit-shop`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/packages/sdkwork-modelkit-shop`
