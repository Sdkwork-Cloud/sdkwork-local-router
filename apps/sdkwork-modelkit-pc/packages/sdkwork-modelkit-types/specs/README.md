...
This directory is the local SDKWork component contract for `@sdkwork/modelkit-types`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/packages/sdkwork-modelkit-types`
