...
This directory is the local SDKWork component contract for `@sdkwork/modelkit-repos`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/packages/sdkwork-modelkit-repos`
