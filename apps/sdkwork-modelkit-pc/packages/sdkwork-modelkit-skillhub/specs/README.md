...
This directory is the local SDKWork component contract for `@sdkwork/modelkit-skillhub`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/packages/sdkwork-modelkit-skillhub`
