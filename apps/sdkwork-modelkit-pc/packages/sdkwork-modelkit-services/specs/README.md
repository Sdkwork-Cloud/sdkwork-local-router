...
This directory is the local SDKWork component contract for `@sdkwork/modelkit-services`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/packages/sdkwork-modelkit-services`
