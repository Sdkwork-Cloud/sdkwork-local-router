...
This directory is the local SDKWork component contract for `node-domexception`.

- Component root: `sdkwork-local-router/apps/sdkwork-modelkit-pc/mocks/node-domexception`
