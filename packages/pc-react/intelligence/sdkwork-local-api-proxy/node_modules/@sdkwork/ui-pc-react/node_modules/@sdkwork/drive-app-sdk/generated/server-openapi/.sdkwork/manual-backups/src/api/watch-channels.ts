...
import type { CreateWatchChannelRequest, DriveWatchChannel, DriveWatchChannelListResponse, StopWatchChannelRequest, StopWatchChannelResponse } from '../types';
...
export class WatchChannelsChangesApi {
  private client: HttpClient;
...
export class WatchChannelsApi {
  private client: HttpClient;
  public readonly changes: WatchChannelsChangesApi;
  public readonly nodes: WatchChannelsNodesApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.changes = new WatchChannelsChangesApi(client);
    this.nodes = new WatchChannelsNodesApi(client);
  }
...
export function createWatchChannelsApi(client: HttpClient): WatchChannelsApi {
  return new WatchChannelsApi(client);
}
