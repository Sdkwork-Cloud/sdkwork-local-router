...
This directory is the local SDKWork component contract for `sdkwork-lr-observability`.

- Component root: `sdkwork-local-router/crates/sdkwork-lr-observability`
